  ...
  <div class="col-xl-12">
    <div class="card shadow">
      <div class="card-header">
        <h4 class="text-center">Receipt Voucher</h4>
      </div>
      <div class="card-body">

        <div class="row justify-content-end mb-2">
          <div class="col-xl-3 mb-2">
            <a href="/receipt/manage" class="btn btn-primary btn-sm btn-block">
              <i class="fas fa-bars pr-2"></i>จัดการระบบ
            </a>
          </div>
          <div class="col-xl-3 mb-2">
            <a href="/receipt/create" class="btn btn-success btn-sm btn-block">
...
<!-- <script>
  ...
  function filter_datatable() {
    ...
    $(".manager-finance-data").DataTable({
      ...
      order: [],
      ajax: {
        url: "/receipt/manager-finance-data",
        type: "POST",
      },
      columnDefs: [{
        targets: [0, 1],
