...
$result = $ASSET->asset_download($type, $warehouse, $location, $brand);
...
$columns = ["เลขที่ทรัพย์สิน", "ชื่อ", "ประเภท", "คลัง", "สถานที่", "ยี่ห้อ", "หน่วยนับ", "ขนาด", "วัสดุ", "หมายเหตุ"];
