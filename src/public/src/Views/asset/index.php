    ...
    <div class="card shadow">
      ...
      <div class="card-body">
        ...
        <div class="row mb-2">
          ...
          <div class="col-xl-3 mb-2">
            <a href="/asset-brand" class="btn btn-info btn-sm btn-block">
              <i class="fas fa-list pr-2"></i>ยี่ห้อ
            </a>
          </div>
          <div class="col-xl-3 mb-2">
            <a href="/asset-unit" class="btn btn-info btn-sm btn-block">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
        <form action="/asset/upload" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
          <div class="row mb-2">
...
<script>
  ...
  $(document).on("click", ".btn-download", function() {
    ...
    window.open("/asset/download/" + type + "/" + warehouse + "/" + location + "/" + brand);
  });
