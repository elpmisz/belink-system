...
$row = $DEPARTMENT->department_view([$id]);
?>

<div class="card shadow">
  <h4 class="card-header text-center">ฝ่าย / แผนก</h4>
  <div class="card-body">

    <form action="/department/update" method="POST" class="needs-validation" novalidate>
