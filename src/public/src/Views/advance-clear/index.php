  ...
  <div class="col-xl-12">
    <div class="card shadow">
      <div class="card-header">
        <h4 class="text-center">ระบบใบขอเคลียร์ Clear Advance Payment</h4>
      </div>
      <div class="card-body">

        <div class="row justify-content-end mb-2">
          <div class="col-xl-3 mb-2">
            <a href="/advance-clear/create" class="btn btn-success btn-sm btn-block">
...
<script>
  ...
  function filter_datatable() {
    $(".request-data").DataTable({
      ...
      order: [],
      ajax: {
        url: "/advance-clear/request-data",
        type: "POST",
      },
      columnDefs: [{
        targets: [0, 1, 3, 6],
    ...
    $(".approve-data").DataTable({
      ...
      order: [],
      ajax: {
        url: "/advance-clear/approve-data",
        type: "POST",
      },
      columnDefs: [{
        targets: [0, 1, 3, 6],
